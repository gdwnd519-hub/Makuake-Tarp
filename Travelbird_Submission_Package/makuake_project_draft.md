...
**2本のポールで広がる無限の解放感。全天候型・2モード変形タープで自由なキャンプを**
*(文字数: 40文字)*
...
1. 改良型ダブルポールが生み出す「圧倒的広さ」と「設営のしやすさ」。全天候対応サイドカーテン搭載。
...
#### Point 2: 変幻自在の「サイドカーテン」システム

天候に合わせて形状を変えられるサイドカーテンを装備。
...
- **ファミリーキャンプ**: サイドカーテンを上げて、開放的なリビングとして。
